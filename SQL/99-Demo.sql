...
BEGIN
    ...
    VALUES ('159888207', 'Omar', 'Carmona', 'Rivas', '987654321', N'ocarmona@gmail.com', N'/Images/User.jpg', 1, N'MTIzNDU2', 1);
END;
ELSE
BEGIN
    UPDATE dbo.Usuarios
    SET Nombres = 'Omar', ApPaterno = 'Carmona', ApMaterno = 'Rivas', Telefono = '987654321', Email = N'ocarmona@gmail.com',
        RutaImagen = N'/Images/User.jpg', Clave = N'MTIzNDU2', Estado = 1
    WHERE Rut = '159888207';
END;
GO
...
BEGIN
    ...
    VALUES ( 138, 2010, 22000, 'ABCD12', N'/Images/Aveo_2010_ABCD12.png', N'5 Puertas, Frenos ABS, Cierre centralizado', 1 );
END;
ELSE
BEGIN
    UPDATE dbo.Vehiculos
    SET IdModelo = 138, Anio = 2010, Valor = 22000, RutaImagen = N'/Images/Aveo_2010_ABCD12.png',
